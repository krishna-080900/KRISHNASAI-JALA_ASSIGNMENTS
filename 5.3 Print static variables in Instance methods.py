#5.3 Print static variables in Instance methods
...
class MyClass:
    ...
    def instance_method1(self):
        # Accessing static variables inside an instance method
        print(f"Instance Method 1: static_var1 = {MyClass.static_var1}")

    def instance_method2(self):
        # Accessing static variables inside an instance method
        print(f"Instance Method 2: static_var2 = {MyClass.static_var2}")
    ...
    def main():
        ...
        # Access modified static methods and instance methods
        obj.instance_method1()
        obj.instance_method2()
